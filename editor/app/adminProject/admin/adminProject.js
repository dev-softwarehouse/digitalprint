        ...
        var loadWS = function( projectData, adminProjectID ){
            ...
            for( var key in _formats ){
                ...
                format.addEventListener('click', function( e ){
                    ...
                    Editor.webSocketControllers.format.load( this.getAttribute( 'admin-project-id' ), this.getAttribute( 'format-name' ), this.getAttribute( 'format-id' ), this.getAttribute( 'format-width' ), this.getAttribute( 'format-height' ), this.getAttribute( 'format-slope' ),function( data ){
